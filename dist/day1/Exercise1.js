 ...
 */
let username; // Declares a string variable (no value yet)
let age; // Declares a number variable (no value yet)
let isloggedin; // Declares a boolean variable (no value yet)
 ...
 */
let username1 = "John Doe"; // String variable with initial value
let age1 = 30; // Number variable with initial value
let isloggedin1 = true; // Boolean variable with initial value
